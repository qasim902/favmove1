        ...
        <div class="bottom40">
          ...
          <div class="agent_wrap">
            ...
            <ul class="nav nav-tabs tabs-left">
              <li class="active">
                <a href="#home" data-toggle="tab">My Listings</a>
              </li>
              <li>
    ...
    <div class="col-md-10 col-xs-12">
      ...
      <div class="tab-content">
          ...
          <div id="deals" class="bottom40">
            <div class="row">
              ...
              ?> default_clr">
                            ...
                            <h4>£
                              <?= $property['price']?>
                                <? if($property['status'] == 'rent') echo "Per Month" ?> -
                                  <small>
                                    <?php if ($property['is_feat'] == "1")
              {
                echo "Featured";
              }
              ...
              ?> </small>
                          ...
                          <div class="dealer clearfix">
                            ...
                            <i class="author">
                              <img width="70" src="<?php echo $assets." img/agency/
                                ".$viewdata['agentdata']['agency_id']?>/logo.png" alt="agency">
                            </i>
                            <h4>
                              <?= $viewdata['agentdata']['name']?> &nbsp;
                                <small>- Agent</small>
              ...
              ?> property_meta">
                            <span>
                              ...
                              <?= $property['prop_details']['area']?> sq ft</span>
                            <span>
                              <i class="icon-bed"></i>
                              <?= $property['prop_details']['bedrooms']?> Bedrooms</span>
                            <span>
                              <i class="icon-safety-shower"></i>
                              <?= $property['prop_details']['bathrooms']?> Bedrooms</span>
                            <span>
                              <i class="icon-old-television"></i>
                              <?= $property['prop_details']['lounge']?>TV Lounge</span>
                          </div>
                        </div>
                      </div>
                    </div>
        ...
        <div class="tab-pane" id="profile">
          ...
          print_r($viewdata['agentdata']);?>
        </div>

        <div class="tab-pane" id="messages">
          <?php foreach ($viewdata['my_inq'] as $inq) {
